...
import com.example.mobileapplicationfinal.databinding.ActivityMainDashboardBinding;
...
public class main_dashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(
                ...
                .build();
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_activity_main_dashboard);
